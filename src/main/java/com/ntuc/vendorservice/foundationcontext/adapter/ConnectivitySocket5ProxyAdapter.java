...
public class ConnectivitySocket5ProxyAdapter extends Socket {
	...
	public ConnectivitySocket5ProxyAdapter(final String jwtToken, final String sccLocationId) {
		this.jwtToken = jwtToken;
		this.sccLocationId = sccLocationId != null ? Base64.getEncoder().encodeToString(sccLocationId.getBytes()) : "";
	}
	public ConnectivitySocket5ProxyAdapter(final String jwtToken) {
		this.jwtToken = jwtToken;
		this.sccLocationId =  "";
	}
	...
	protected InetSocketAddress getProxyAddress() {
		try {
			JSONObject credentials = AdapterUtils.getConnectivityAuthServiceCredentials();
