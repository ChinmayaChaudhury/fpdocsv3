package com.ntuc.vendorservice.foundationcontext.filters;
...
/*@WebFilter("/*")
public class XUAASecurityFilter implements Filter {
    private static final Logger LOGGER = LoggerFactory.getLogger(XUAASecurityFilter.class);
    private final AbstractTokenAuthenticator xsuaaTokenAuthenticator;

    public XUAASecurityFilter() {
        // in productive usage never use a default rest client!
        // TO-DO update the filter
