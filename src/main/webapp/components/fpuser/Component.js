 ...
 * 
 */
jQuery.sap.declare("sap.docs.fpuser.Component");
sap.ui.core.UIComponent.extend("sap.docs.fpuser.Component",{
	metadata: {
		...
		init : function() {  
	        ...
	        this.router.register("fpuserRouter");
	        this.router.initialize(); 
	    },
	    createContent : function() {
	        this.view = sap.ui.view({
	            id : this.createId("FpUserApp"),
	            viewName : "view.fpuser.App",
	            type : "XML"
	        }); 
	        return this.view;
	    },
