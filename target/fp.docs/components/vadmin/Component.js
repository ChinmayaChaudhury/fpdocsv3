 ...
 * 
 */
jQuery.sap.declare("sap.docs.vadmin.Component");
sap.ui.core.UIComponent.extend("sap.docs.vadmin.Component",{
	metadata: {
		  name: "Vendor Administrator Module",
		  version: "1.0",
		  routing : {
		    config: {
		      viewType: "XML",
		      viewPath: "view.vadmin",
		...
		init : function() {  
	        ...
	        this.router.register("vAdminRouter");
	        this.router.initialize(); 
	    },
	    createContent : function() {
	        this.view = sap.ui.view({
	            id : this.createId("App"),
	            viewName : "view.vadmin.App",
	            type : "XML"
	        }); 
	        return this.view;
	    },
