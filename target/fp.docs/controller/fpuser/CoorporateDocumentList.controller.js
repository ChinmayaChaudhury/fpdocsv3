sap.ui.controller("controller.fpuser.CoorporateDocumentList", {
	 ...
	 * initialization.
	 * 
	 * @memberOf controller.fpuser.CoorporateDocumentList
	 */
	onInit : function() {   
	...
	loadRequiredData:function(){
		...
		var rootData=Connection.requestData(Configuration.fairPriceUserAccountServiceUrl.queryCoorporateDocs); 
	...
	handleDownload:function(oEvent){
		var sPath=this.byId('inboxList').getSelectedItem().getBindingContext("corp").sPath;
	...
	onBackPress:function(oEvent){
		...
		var url=Configuration.fairPriceUserAccountServiceUrl.generalDocumentQuery;
